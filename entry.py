...
def prepare_1():
    ...
    # parallel setting
    parser.add_argument("--set_aggr", type=str, default="item_iu")
    parser.add_argument("--aggregation", type=str, default="aggregation")

    parser.add_argument("--codebook_num", type=int, default=4)
    parser.add_argument("--codebook_size", type=int, default=12)
    parser.add_argument("--RQVAE", type=str2bool, default=True)
    parser.add_argument("--pretrain_rq", type=str2bool, default=True)
    parser.add_argument("--pretrain_epochs", type=int, default=50)
    parser.add_argument("--freeze_rq", type=str2bool, default=True)
    parser.add_argument("--cross_cond", type=str2bool, default=False)
    parser.add_argument("--start_point", default="noise")
    parser.add_argument("--rqvae_lr", type=float, default=0.001)
    parser.add_argument("--rq_num", type=int, default=0)

    # item cond
    parser.add_argument("--diff_task_lambda", type=float, default=1.0)
    parser.add_argument("--diff_scale", type=float, default=0.5)
    parser.add_argument("--diff_mask_rate", type=float, default=0.1)
    parser.add_argument("--emb_dim", type=int, default=10)
    parser.add_argument("--bias_mapping", type=str, default="user")
    parser.add_argument("--mapping_lambda", type=float, default=10)
    parser.add_argument("--uniformity_loss", type=float, default=0.1)
    parser.add_argument("--zero_cond", type=str2bool, default=False)
    parser.add_argument("--batch_norm", type=str2bool, default=False)
    parser.add_argument("--recon_loss", type=float, default=0.1)
...
if __name__ == "__main__":
    ...
    write(f"🍎 start point : {args.start_point}")
